...
export default function ModelSelectionStep(props) {
  ...
  function handleModelSelection(sneaker) {
            ...
            {searchInput
              ? getSearchResults().map((sneaker, i) => {
                  ...
                  <ListItem key={i} bottomDivider 
                    ...
                    onPress={() => handleModelSelection(sneaker)}
                  >
                    <Image style={{width: '50%', height: '100%'}} source={{uri: sneaker.image}}/>
                    <ListItem.Content>
                      <ListItem.Title style={styles.resultModel}>{sneaker.model}</ListItem.Title>
                      <ListItem.Subtitle style={styles.resultBrand}>{sneaker.brand}</ListItem.Subtitle>
                    </ListItem.Content>
                  </ListItem>);
                })
              : null
